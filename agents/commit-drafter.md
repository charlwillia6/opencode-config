...
- Read `.opencode/context/SESSION_CONTEXT.md` (if it exists) to understand current session state including active feature branch, build status, and pending tasks
